...
/**
 * Created by Hale Yang on 2017/9/14.
 *
 */
...
public class PullToRefreshNeoRecyclerView extends PullNeoNestedToRefresh<RecyclerView>{
    ...
    public PullToRefreshNeoRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PullToRefreshNeoRecyclerView(Context context, Mode mode) {
        super(context, mode);
        init(context);
    }

    public PullToRefreshNeoRecyclerView(Context context, Mode mode, AnimationStyle animStyle) {
